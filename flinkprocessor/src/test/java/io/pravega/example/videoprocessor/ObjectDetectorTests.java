...
//    @Ignore
    public void Test1() throws Exception {
        ...
        byte[] inBytes = Files.readAllBytes((new File("/home/vidyat/Desktop/video-samples/data/test_truck.jpg")).toPath());

        byte[] outBytes = TFObjectDetector.getInstance().detect(inBytes);

//        log.info("The output image is: {}", outBytes);
        Files.write((new File("/home/vidyat/Desktop/video-samples/data/detected_test_truck.jpg")).toPath(), outBytes);
    }
