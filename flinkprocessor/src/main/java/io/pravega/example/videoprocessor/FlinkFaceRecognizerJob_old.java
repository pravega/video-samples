...
// */
//public class FlinkFaceRecognizerJob_old extends AbstractJob {
//    // Logger initialization
//    private static Logger log = LoggerFactory.getLogger(FlinkFaceRecognizerJob_old.class);
//
//    /**
...
//        FlinkFaceRecognizerJob_old job = new FlinkFaceRecognizerJob_old(config);
//        job.run();
//    }
//
//    public FlinkFaceRecognizerJob_old(VideoAppConfiguration config) {
//        super(config);
//    }
//
//    @Override
...
//            final String jobName = FlinkFaceRecognizerJob_old.class.getName();
