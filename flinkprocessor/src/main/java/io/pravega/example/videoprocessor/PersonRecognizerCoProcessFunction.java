 ...
 */
class PersonRecognizerCoProcessFunction extends CoProcessFunction<OrderedVideoFrame, OrderedVideoFrame, OrderedVideoFrame> {
    private static Logger log = LoggerFactory.getLogger(PersonRecognizerCoProcessFunction.class);
    ...
    public PersonRecognizerCoProcessFunction(int operator, int parallelism) {
